...
describe('List', () => {
  ...
  test('List renders an ordered list when `ordered` prop is true', () => {
  ...
  test('List renders the list items', () => {
    const { container } = render(<List {...defaultProps} />)
  ...
  test('List renders with a custom bullet style', () => {
    const { container } = render(<List {...defaultProps}/>)
    const listElement = container.querySelector('ul')
    expect(listElement?.className).toContain('circle')
  })
  test('List renders with a custom class', () => {
    const { container } = render(<List {...defaultProps}/>)
    const listElement = container.querySelector('ul')
